...
public class CatalogsGroupRsp {
    ...
    private int level;
    private List<CatalogsGroupRsp> sub;


    public static CatalogsGroupRsp.CatalogsGroupRspBuilder buildByCatalogs(Catalogs c){

    return CatalogsGroupRsp.builder()
        .cat_id(c.getId())
        .cat_name(c.getName())
        .item_id(c.getItemId())
