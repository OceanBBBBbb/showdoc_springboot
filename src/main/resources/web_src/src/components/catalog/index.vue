...
export default {
  ...
  methods: {
          ...
          .then(function (response) {
            if (response.data.error_code === 0 ) {
              ...
              for (var i = 0; i < Info.length; i++) {
                ...
                if (null != Info[i]['sub'] && Info[i]['sub'].length > 0 ) {
      ...
      MyFormSubmit() {
          ...
          var params = new URLSearchParams();
          var pCatId;
          if(this.MyForm.parent_cat_id===undefined||this.MyForm.parent_cat_id===''){
            pCatId=0;
          }else{
            pCatId=this.MyForm.parent_cat_id;
          }
          params.append('item_id',  that.$route.params.item_id);
          params.append('cat_id', this.MyForm.cat_id===undefined?0:this.MyForm.cat_id);
          params.append('parent_cat_id',pCatId);
          params.append('cat_name', this.MyForm.cat_name);
          params.append('s_number', this.MyForm.s_number===undefined?99:this.MyForm.s_number);
