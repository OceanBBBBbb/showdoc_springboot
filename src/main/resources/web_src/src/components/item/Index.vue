    ...
    <el-container class="container-narrow">
      ...
      <el-row class="masthead">
          ...
          <div class="logo-title ">
              <h2 class="muted"><img src="static/logo/b_64.png" style="width:50px;height:50px;margin-bottom:-10px;" alt="">ShowDoc-SpringBoot版</h2>
          </div>
      ...
      <el-container class="container-narrow">
        <div class="container-thumbnails">
          <ul class="thumbnails" id="item-list" v-if="itemList">
              ...
              <li class="text-center"  v-for="item in itemList" :key='item'>
...
export default {
  ...
  methods:{
    ...
    feedback(){
      window.open('https://github.com/OceanBBBBbb/showdoc_springboot/issues');
    },
    item_top_class(top){
      if (top) {
